...
from config import *
from modules import Bird, Pipe, Pipes, Base
...
class FlappyBirdApp(object):
    ...
    def __init__(self, genomes, config):
        ...
        """  CREATE PLAYER """
        self.movementInfo = load_and_initialize()
    ...
    def on_render(self):
        ...
        """ DRAW STATS """
        # =========----==========================================================
        displayStat(SCREEN, self.birds[0].distance * -1, text="distance")
        displayStat(SCREEN, self.score, text="scores")
        for bird in self.birds:
